...
export class cob extends ethereum.SmartContract {
  static bind(address: Address): cob {
    return new cob("cob", address);
  }
  ...
  REWARDSSUPPLY(): BigInt {
    let result = super.call("REWARDSSUPPLY", "REWARDSSUPPLY():(uint256)", []);

    return result[0].toBigInt();
  }

  try_REWARDSSUPPLY(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "REWARDSSUPPLY",
